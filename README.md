...
(For GitHub staff only) Check out this talk (9 minutes 30 seconds) from @heymie for more tips on [prototyping with Primer React](https://github.rewatch.com/video/sniwdhyn3qqcvjsq-prototyping-with-primer-react-lightning-talk).
